...
const Footer = () => {
  return (
    <footer className={styles["footer"]}>
      ...
      <div className={styles["footer__navigation"]}>Nav</div>
      <div className={styles["footer__info"]}>Info
        <p className={styles["info__rights"]}>Ecobazar eCommerce © 2023. All Rights Reserved</p>
      </div>
    </footer>
  );
};
